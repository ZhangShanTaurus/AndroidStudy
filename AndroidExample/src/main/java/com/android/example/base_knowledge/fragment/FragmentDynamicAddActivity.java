...
import com.android.example.base_knowledge.fragment.sample.FragmentContacts;
import com.android.example.base_knowledge.fragment.sample.FragmentFriend;
import com.android.example.base_knowledge.fragment.sample.FragmentMessage;
import com.android.example.base_knowledge.fragment.sample.FragmentSpace;
...
public class FragmentDynamicAddActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_dynamic_add_layout);
        initView();
        initData();
    }
    ...
    public void setFragment(int i) {
        ...
        switch (i) {
            case 0:
                ...
                btn_message.setTextColor(getResources().getColor(R.color.Red));
                if (fragmentMessage == null) {
                    fragmentMessage = new FragmentMessage();
                    // 如果fragmentMessage为空，则创建一个并添加到界面上
                    transaction.add(R.id.frameLayout_content, fragmentMessage);
                } else {
            ...
            case 1:
                ...
                btn_friend.setTextColor(getResources().getColor(R.color.Red));
                if (fragmentFriend == null) {
                    fragmentFriend = new FragmentFriend();
                    transaction.add(R.id.frameLayout_content, fragmentFriend);
                } else {
            ...
            case 2:
                ...
                btn_contacts.setTextColor(getResources().getColor(R.color.Red));
                if (fragmentContacts == null) {
                    fragmentContacts = new FragmentContacts();
                    transaction.add(R.id.frameLayout_content, fragmentContacts);
                } else {
            ...
            case 3:
                ...
                btn_space.setTextColor(getResources().getColor(R.color.Red));
                if (fragmentSpace == null) {
                    fragmentSpace = new FragmentSpace();
                    transaction.add(R.id.frameLayout_content, fragmentSpace);
                } else {
    ...
    public void clearSelection() {
        ...
        btn_friend.setTextColor(getResources().getColor(R.color.Black));
        btn_contacts.setTextColor(getResources().getColor(R.color.Black));
        btn_space.setTextColor(getResources().getColor(R.color.Black));
    }

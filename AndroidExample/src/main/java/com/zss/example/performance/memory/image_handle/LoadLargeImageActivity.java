package com.zss.example.performance.memory.image_handle;
...
public class LoadLargeImageActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_load_large_image_layout);
        initView();
        initData();
    }
    ...
    public void initView() {
        ...
        imageView_compress = (ImageView) findViewById(com.zss.example.R.id.imageView_compress);
    }
    ...
    public void initData() {
        ...
        imageView_compress.setImageBitmap(decodeSampledBitmapFromResource(getResources(), com.zss.example.R.drawable.activity_lunch_mode_single_instance, 100, 100));
    }

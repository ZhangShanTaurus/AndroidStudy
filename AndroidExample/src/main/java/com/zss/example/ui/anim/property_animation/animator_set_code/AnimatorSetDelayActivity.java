...
public class AnimatorSetDelayActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_animator_set_delay_layout);
        initView();
        initData();
    }
    ...
    public void initView() {
        ...
        tv_one = (TextView) findViewById(com.zss.example.R.id.tv_one);
        tv_two = (TextView) findViewById(com.zss.example.R.id.tv_two);
        btn_one_delay = (Button) findViewById(com.zss.example.R.id.btn_one_delay);
        btn_one_delay.setOnClickListener(this);
        btn_two_delay = (Button) findViewById(com.zss.example.R.id.btn_two_delay);
        btn_two_delay.setOnClickListener(this);
        btn_set_delay = (Button) findViewById(com.zss.example.R.id.btn_set_delay);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case com.zss.example.R.id.iv_back:
                onBackPressed();
                break;
            case com.zss.example.R.id.btn_one_delay:
                doOneDelay();
                break;
            case com.zss.example.R.id.btn_two_delay:
                doTwoDelay();
                break;
            case com.zss.example.R.id.btn_set_delay:
                doSetDelay();
                break;
            default:
                break;

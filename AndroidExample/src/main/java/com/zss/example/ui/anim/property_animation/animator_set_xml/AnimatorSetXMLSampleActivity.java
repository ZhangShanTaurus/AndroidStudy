...
public class AnimatorSetXMLSampleActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_animator_set_xml_sample_layout);
        initView();
        initData();
    }
    ...
    public void initView() {
        ...
        btn_menu = (Button) findViewById(com.zss.example.R.id.btn_menu);
        btn_menu.setOnClickListener(this);
        btn_menu_item1 = (Button) findViewById(com.zss.example.R.id.btn_menu_item1);
        btn_menu_item1.setOnClickListener(this);
        btn_menu_item2 = (Button) findViewById(com.zss.example.R.id.btn_menu_item2);
        btn_menu_item2.setOnClickListener(this);
        btn_menu_item3 = (Button) findViewById(com.zss.example.R.id.btn_menu_item3);
        btn_menu_item3.setOnClickListener(this);
        btn_menu_item4 = (Button) findViewById(com.zss.example.R.id.btn_menu_item4);
        btn_menu_item4.setOnClickListener(this);
        btn_menu_item5 = (Button) findViewById(com.zss.example.R.id.btn_menu_item5);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case com.zss.example.R.id.iv_back:
                onBackPressed();
                break;
            case com.zss.example.R.id.btn_menu:
                if (!isMenuOpen) {
                    isMenuOpen = true;

...
/**
 * 描述：ObjectAnimatorPrincipleActivity
 * Created by Administrator on 2016/1/21 0021.
 */
public class ObjectAnimatorPrincipleActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_object_animator_principle_layout);
        initView();
        initData();
    }

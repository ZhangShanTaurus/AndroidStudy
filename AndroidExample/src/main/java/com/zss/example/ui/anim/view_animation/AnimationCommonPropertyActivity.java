 ...
 */
public class AnimationCommonPropertyActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_animation_common_property_layout);
        initView();
        initData();
    }

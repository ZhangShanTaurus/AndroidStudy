...
public class AnimationRotateActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_animation_rotate_layout);
        initView();
        initData();
    ...
    public void initView() {
        ...
        tv_rotate_xml = (TextView) findViewById(com.zss.example.R.id.tv_rotate_xml);
        tv_rotate_java = (TextView) findViewById(com.zss.example.R.id.tv_rotate_java);
    }
    ...
    public void initData() {
        ...
        Animation animation = AnimationUtils.loadAnimation(this, com.zss.example.R.anim.animation_rotate);

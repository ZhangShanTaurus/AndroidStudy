...
public class TimePickerActivity extends BaseActivity implements View.OnClickListener, TimePicker.OnTimeChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zss.example.R.layout.activity_time_picker_layout);
        initView();
        initData();
    }
    ...
    public void initView() {
        ...
        btn_show_dialog = (Button) findViewById(com.zss.example.R.id.btn_show_dialog);
        btn_show_dialog.setOnClickListener(this);
        tv_showTime = (TextView) findViewById(com.zss.example.R.id.tv_showTime);
        tv_showTime2 = (TextView) findViewById(com.zss.example.R.id.tv_showTime2);
        timePicker = (TimePicker) findViewById(com.zss.example.R.id.timePicker);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case com.zss.example.R.id.iv_back:
                onBackPressed();
                break;
            case com.zss.example.R.id.btn_show_dialog:
                showDialog();
                break;
            default:
                break;
